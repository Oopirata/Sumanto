                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-3 text-center text-xs font-medium text-black uppercase border-b-2 border-black">IPK</th>
                            <th class="px-4 py-3 text-center text-xs font-medium text-black uppercase border-b-2 border-black">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="py-4 px-6 text-center">
                                <button onclick="window.location.href='{{ url('staff/detailnilaimhs') }}'" class="bg-gray-200 text-gray-600 py-1 px-4 rounded-lg hover:bg-gray-300">Detail</button>
                            </td>
                        </tr>
                        <tr>
