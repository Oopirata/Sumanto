<div class="flex h-screen font-poppins">
    ...
    <aside class="flex flex-col w-64 bg-white shadow-lg fixed top-0 left-0 h-full z-10"
        ...
        <div class="flex flex-col mt-6 flex-grow margin-bottom: 50px;">
            <!-- Dashboard -->
            <a href="/mhs/dashboard"
                class="inline-flex items-center mx-5 px-6 py-2 text-gray-600 hover:bg-[#5932EA] focus:bg-[#5932EA] hover:text-white focus:text-white rounded-lg transition-all mb-2">
            ...
            <div x-data="{ open: false }" class="relative mx-5 mt-4">
                <button @click="open = !open"
                    class="flex items-center px-6 py-2 w-full text-gray-600 hover:bg-[#5932EA] focus:bg-[#5932EA] hover:text-white focus:text-white rounded-lg transition-all focus:outline-none mb-2">
                    <span class="material-icons"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <svg class="ml-auto h-5 w-5 transition-transform" :class="{ 'rotate-180': open }" fill="none"
                ...
                <div x-show="open" class="mt-2 space-y-1 pl-6">
                    <div class="flex items-center my-5">
                        <a href="/mhs/bayar"
                            class="ml-2 text-sm text-gray-600 hover:text-blue-600 transition-colors">Biaya Kuliah</a>
                    </div>
                    <div class="flex items-center my-5">
                        <a href="/mhs/status"
                            class="ml-2 text-sm text-gray-600 hover:text-blue-600 transition-colors">Status kuliah</a>
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ open: false }" class="relative mx-5 mt-4">
                ...
                <div x-show="open" class="mt-2 pl-6">
                    <div class="flex items-center my-5">
                        <a href="/mhs/BuatIrs"
                            class="ml-2 text-sm text-gray-600 hover:text-blue-600 transition-colors">Buat IRS</a>
                    </div>
                    <div class="flex items-center my-5">
                        <a href="/mhs/irs"
                            class="ml-2 text-sm text-gray-600 hover:text-blue-600 transition-colors">IRS</a>
                    </div>
                    <div class="flex items-center my-5">
                        <a href="/mhs/khs"
                            class="ml-2 text-sm text-gray-600 hover:text-blue-600 transition-colors">KHS</a>
                    </div>
                </div>
            </div>
        </div>
