<div class="flex h-screen font-poppins">
    ...
    <aside class="flex flex-col w-64 bg-white shadow-lg fixed top-0 left-0 h-full z-10" style="border-top-right-radius: 20px; border-bottom-right-radius: 20px;">
        ...
        <div class="flex flex-col mt-6 flex-grow margin-bottom: 50px;">
            <!-- Dashboard -->
            <a href="/dosen/dashboard" class="inline-flex items-center mx-5 px-6 py-2 text-gray-600 hover:bg-[#5932EA] focus:bg-[#5932EA] hover:text-white focus:text-white rounded-lg transition-all mb-2">
            ...
            <!-- Input Nilai -->
            <a href="/dosen/PengajuanNilai" class="inline-flex items-center mx-5 px-6 py-2 text-gray-600 hover:bg-[#5932EA] focus:bg-[#5932EA] hover:text-white focus:text-white rounded-lg transition-all mb-2 mt-4">
            ...
            <div class="ml-4">
                ...
                <p class="text-xs text-gray-600">{{ $dosen->nip }} - Informatika S1</p>
            </div>
        </div>
    </aside>
</div>
